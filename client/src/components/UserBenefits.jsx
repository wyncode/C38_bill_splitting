      ...
      <div className="row">
        ...
        <div className="col" id="benefitrewards">
          ...
          <i
            ...
            style={{ size: '3rem', color: '#41ccaa', width: '50px' }}
          ></i>
          ...
          <img
            src={
              'https://res.cloudinary.com/jeanniet89/image/upload/v1598822858/Cuenta%20App/Cuenta_shield_yis559.png'
            }
            alt="Plus Icon"
            style={{ width: '30px', size: '3rem' }}
          />
