...
const UserRewards = () => {
  return (
    ...
    <div className="card-img-overlay">
      <h4 id="rewardstext" className="card-title" style={{color:'white'}}>Sign up to unlock deals near you!!</h4>
      <Button id="rewardsbtn" href="/signup" variant="link" style={{ size:'20px', color:'#41ccaa' }}>Sing Up</Button>
       </div>
      </div>
    </>
  );
